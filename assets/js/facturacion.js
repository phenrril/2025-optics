        ...
        html: `
            <div class="text-left">
                <div class="form-group mb-2">
                    <label for="swal-nombre-cliente">Nombre / Razón social</label>
                ...
                <div class="form-group mb-2">
                    <label for="swal-cuit">CUIT</label>
                ...
                <div class="form-group mb-2">
                    <label for="swal-tipo-factura">Tipo de factura</label>
                    <select id="swal-tipo-factura" class="swal2-select" style="margin: 0; width: 100%;">
